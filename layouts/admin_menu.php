<ul>
  ...
  <li>
    ...
    <ul class="nav submenu">
       <li><a href="products/product.php">Administrar productos</a> </li>
       <li><a href="products/add_product.php">Agregar productos</a> </li>
   </ul>
  </li>
  <li>
    <a href="#" class="submenu-toggle">
    ...
    <ul class="nav submenu">
      <li><a href="providers/provider.php" target="_blank">Administrar proveedores</a> </li>
      <li><a href="providers/add_provider.php" target="_blank">Agregar proveedores</a> </li>
   </ul>
  </li>
  <li>
    <a href="media.php" >
